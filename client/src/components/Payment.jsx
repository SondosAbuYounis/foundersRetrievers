...
//   return (
//     <Modal style={FormDivStyle}>
//     <div className='p-8 grid grid-col-3 justify-items-stretch  pr-28 pl-28 bg-[#373737] rounded-[2rem] w-[60rem] ' >
//             <div className="col-span-3 justify-self-center text-[2.25rem] font-extralight pb-12 pt-8 text-[#fff]">Payment</div>
//             <form onSubmit={handleSubmit} style={FormStyle} className="grid grid-cols-3 gap-12" >
//             <div> 
...
//             <label className='	font-light mb-1 text-[#CDCDCD84]'>Country details</label>
...
//                 <div className=''>
//                 <div className='	text-center font-light mb-8 text-[#fff] text-[1.25rem] '>Card details</div>

//                 <label className='	font-light  text-[#CDCDCD] '>Card number</label>
//                     <input
//                     type="integer"
//                     name="cardnumber"
//                     style={inputBorderStyle}
