...
export const Navbar = () => {
  ...
  return (
    <div className='flex flex-row justify-around'>
        ...
        <img src={LogoTwoPng} className='px-3 pb-2 mt-6 h-[4.25rem] justify-self-start	'/>
        <ul className='flex flex-row pt-2 mt-4'>
            <li className=' mb-2 mt-6 mx-2'>
                <Link to="/signin" className=" px-3 pb-2 text-[#000000] bg-white focus:outline-none  hover:border hover:border-2 hover:border-[#E83434]  hover:text-[#E83434]  px-5 py-2 rounded-[0.65rem] text-xs font-semibold">SIGN IN</Link>
            </li>
            <li className=' mb-2 mt-6'>
                <Link to="/signup" className=" px-3 pb-2 text-[#E83434] bg-white border border-2 border-[#E83434]  focus:outline-none hover:bg-[#E83434] hover:text-[#FFFFFF] text-xs font-semibold rounded-[0.65rem] text-xs px-5 py-2  dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">SIGN UP</Link>
            </li>
        </ul>
    </div>
  )
