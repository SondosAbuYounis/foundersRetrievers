  ...
  return (
    <div className='flex flex-row justify-between mt-12 mb-12'>
      ...
      <div className='mt-12 p-16 bg-[#86868673] w-[20rem] h-[50rem] rounded-r-[1.25rem] flex flex-col'>
        <div className='flex flex-row gap-6 '>
          ...
          <div className='flex flex-col'>
              <span className='text-[#000] font-light text-[0.9rem] hover:underline flex gap-16 items-center'>Caroline {/* <Edit/> */}  </span>  
              <span className='text-[#00000085] font-light text-[0.75rem] hover:underline flex gap-20 items-center' >Amman {/* <Edit/> */} </span> 
          </div>     
        </div>
        <div className='mt-8 mt-4 text-[#000] font-light text-[0.9rem] hover:underline flex gap-16 items-center border-dotted border-white'>Email</div>
        <hr className=" w-[12rem] border-[#868686] border-dashed  sm:mx-auto dark:border-gray-700 " />
        <div className=' mt-4 text-[#000] font-light text-[0.9rem] hover:underline flex gap-16 items-center'>Phone </div>
        <hr className=" w-[12rem] border-[#868686] border-dashed  sm:mx-auto dark:border-gray-700 " />
        <div className=' mt-4 text-[#000] font-light text-[0.9rem] hover:underline flex gap-16 items-center'>Password</div>
        <hr className=" w-[12rem] border-[#868686] border-dashed  sm:mx-auto dark:border-gray-700 " />
      </div>

      {/* My Posts  */}
      <div className='mt-16'>
        <div className='text-[#000] font-light text-[0.9rem] flex gap-16 items-center'>My posts </div>
      ...
      <div className='mt-12 p-16 bg-[#86868673] w-[20rem] h-[50rem] rounded-l-[1.25rem] flex flex-col gap-4'>
        <ul className='flex flex-col'> Lists
          <hr className=" w-[12rem] border-[#868686] border-dashed  sm:mx-auto dark:border-gray-700 " />
          <li className='ml-4 mt-4 text-[#000] font-light text-[0.9rem] hover:underline flex gap-16 items-center border-dotted border-white'>My Losts</li>
          <li className='ml-4 mt-4 text-[#000] font-light text-[0.9rem] hover:underline flex gap-16 items-center'>My Founds </li>
          <li className='ml-4 mt-4 text-[#000] font-light text-[0.9rem] hover:underline flex gap-16 items-center'>All linked</li>
          <li className='ml-4 mt-4 text-[#000] font-light text-[0.9rem] hover:underline flex gap-16 items-center'>Donate</li>
        ...
        <ul className='flex flex-col mt-4'> Filter by
          <hr className=" w-[12rem] border-[#868686] border-dashed  sm:mx-auto dark:border-gray-700 " />
